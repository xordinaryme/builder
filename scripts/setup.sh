...
wget http://ftp.jp.debian.org/debian/pool/main/n/ncurses/libtinfo5_6.4-4_amd64.deb & sudo dpkg -i libtinfo5_6.4-4_amd64.deb && rm -rf libtinfo5_6.4-4_amd64.deb
